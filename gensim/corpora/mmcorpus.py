...
class MmCorpus(MmReader, IndexedCorpus):
    ...
    def __init__(self, fname, index_fname=None, transposed=True):
        ...
        logger.info('Init the IndexedCorpus for MmCorpus at {} using index_fname={}'.format(fname, index_fname))
        IndexedCorpus.__init__(self, fname, index_fname=index_fname)
        logger.info('Loading the reader for the main docs file {}'.format(fname))
